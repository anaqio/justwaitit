...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen flex items-center justify-center overflow-hidden hero-gradient snap-start">
      {/* Decorative orbs */}
      <motion.div style={{ y: y1 }} className="glow-orb w-[500px] h-[500px] bg-purple-200/40 dark:bg-purple-500/10 top-[-10%] left-[-10%] animate-float-slow" />
      <motion.div style={{ y: y2 }} className="glow-orb w-[400px] h-[400px] bg-pink-200/40 dark:bg-pink-500/10 bottom-[-5%] right-[-5%] animate-float" />
      <motion.div style={{ y: y3 }} className="glow-orb w-[300px] h-[300px] bg-indigo-200/30 dark:bg-indigo-500/8 top-[30%] right-[10%] animate-glow" />
      ...
      >
        ...
        <TypoLogo
          ...
          className="relative w-full max-w-[280px] sm:max-w-[340px] drop-shadow-2xl"
        />
      </motion.div>
